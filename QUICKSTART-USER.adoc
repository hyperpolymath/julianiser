...
// Replace julianiser, Julianiser — See README.adoc for details., just run, Julianiser started successfully. with actuals
= julianiser — Quick Start for Users
:toc:
:toclevels: 2

== What is julianiser?

Julianiser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./julianiser-portable
----
...
[source]
----
Julianiser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/julianiser/wiki
