...
doctor:
    @echo "Running diagnostics for julianiser..."
...
heal:
    @echo "Attempting auto-repair for julianiser..."
...
help-me:
    @echo "=== julianiser Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/julianiser/issues/new"
    @echo ""
